...
Furthermore, as a preparation for this week's seminar, I have created a PowerPoint presentation, which shows disaster recovery (DR) solutions for different scenarios with different Revocery Point Objectives (RPO) and Recovery Time Objectives (RTO). You can find my slides [here](https://github.com/TobiZeier/UoEO_MSc_EIM/blob/main/Module2_Security_and_Risk_Management/Unit10-Seminar-ActivityB.pdf).
