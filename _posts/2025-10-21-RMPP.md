...
This unit introduced the foundations of research methods and their importance in computing. I learned that research serves three main purposes: to explore, describe, and explain (QuestionPro, 2021). The scientific method—comprising observation, hypothesis, reasoning, and testing—is the cornerstone of credible investigation (Anderson & Hepburn, 2020). 
...
Ethics emerged as a vital theme in this unit. The *Menlo Report* (Finn & Shilton, 2023) outlines four principles—Respect, Beneficence, Justice, and Respect for Law and Public Interest—that guide ethical research. These are directly relevant to computing, especially in the age of AI and data-driven systems, where privacy, consent, and accountability are key (Deckard, 2023). Understanding and applying ethical frameworks, including the BCS Code of Conduct, ensures professionalism and integrity in research practice.
